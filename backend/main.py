...
# Habilitar CORS para permitir solicitudes desde cualquier origen si fuera necesario
app.add_middleware(
    CORSMiddleware,
    allow_origins=["*"],
...
@app.get(
    ...
    description="Retorna la fecha actual del sistema formateada exactamente como YYYY-MM-DD.",
...
@app.get(
    ...
    description="Retorna la hora actual del sistema formateada exactamente como HH:MM:SS.",
    tags=["Servicios de Tiempo"]
)
def get_time():
    current_time = datetime.now()
...
@app.get(
    ...
    description="Retorna el timestamp del sistema conteniendo fecha y hora exactamente como YYYY-MM-DD HH:MM:SS.",
    tags=["Servicios de Tiempo"]
)
def get_timestamp():
    current_time = datetime.now()
